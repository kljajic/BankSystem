...
@XmlRootElement(name = "mt900Response", namespace = "http://com/xsdSchemas/rtgsResponseOriginator")
public class Mt900Response {

    @XmlElement(namespace = "http://com/xsdSchemas/rtgsResponseOriginator", required = true)
